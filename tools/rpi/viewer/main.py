...
l_string0 = p_now.line(x='x', y='y', source=source_string0_now, legend_label="String 0", line_color="red")
l_string1 = p_now.line(x='x', y='y', source=source_string1_now, legend_label="String 1", line_color="green")
...
data_generation.the_data.add_doc(doc,
                                 data_generation.MySources(source_now, source_today, source_yesterday,
                                                           source_string0_now, source_string1_now))
